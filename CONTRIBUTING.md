Contributing to NEOS Core
============================

The NEOS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NEOS Core project, and is not to be
confused with overall NEOS Network Protocol consensus changes.

Whether a pull request is merged into NEOS Core rests with the project merge
...
Patches that change NEOS consensus rules are considerably more involved than
...
Where a patch set proposes to change the NEOS consensus, it must have been
...
The project leader is the release manager for each NEOS Core release.
