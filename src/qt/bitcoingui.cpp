                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Neos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NEOS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and neos: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NEOS Core"), this);
    aboutAction->setStatusTip(tr("Show information about NEOS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NEOS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NEOS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NEOS addresses"));
    ...
    openAction->setStatusTip(tr("Open a NEOS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NEOS Core help message to get a list with possible NEOS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NEOS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NEOS network", "", count));
}
...
{
    QString strTitle = tr("NEOS Core"); // default title
