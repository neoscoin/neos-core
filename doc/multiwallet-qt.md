...
In order to support loading of multiple wallets in neos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is neos.cpp.
...
Changes to neos.cpp
----------------------
neos.cpp is the entry point into neos-qt, and as such, will require some minor modifications to provide hooks for
