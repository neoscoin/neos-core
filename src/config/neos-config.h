/* src/config/neos-config.h.  Generated from neos-config.h.in by configure.  */
/* src/config/neos-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NEOS_CONFIG_H

#define NEOS_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.neos.sh"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Neos Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Neos Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "neos"
