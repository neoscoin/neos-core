...
This mechanism has been integrated into Bitcore-Node-NEOS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/NEOS-Project/insight-api-neos#web-socket-api](https://github.com/NEOS-Project/insight-api-neos#web-socket-api) 
* API: [https://github.com/NEOS-Project/insight-api-neos#swifttx-transactions](https://github.com/NEOS-Project/insight-api-neos#swifttx-transactions) 
...
By default, the NEOS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NEOS Core daemon:
