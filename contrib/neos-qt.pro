...
RESOURCES += src/qt/neos.qrc src/qt/neos_locale.qrc

TRANSLATIONS += src/qt/locale/neos_bg.ts \
                src/qt/locale/neos_de.ts \
                src/qt/locale/neos_en.ts \
                src/qt/locale/neos_es.ts \
                src/qt/locale/neos_fi.ts \
                src/qt/locale/neos_fr.ts \
                src/qt/locale/neos_it.ts \
                src/qt/locale/neos_ja.ts \
                src/qt/locale/neos_pl.ts \
                src/qt/locale/neos_pt.ts \
                src/qt/locale/neos_ru.ts \
                src/qt/locale/neos_sk.ts \
                src/qt/locale/neos_sv.ts \
                src/qt/locale/neos_vi.ts \
                src/qt/locale/neos_zh_CN.ts \
                src/qt/locale/neos_zh_TW.ts
