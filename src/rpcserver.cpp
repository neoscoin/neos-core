...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Neos features */
        {"neos", "masternode", &masternode, true, true, false},
        {"neos", "listmasternodes", &listmasternodes, true, true, false},
        {"neos", "getmasternodecount", &getmasternodecount, true, true, false},
        {"neos", "masternodeconnect", &masternodeconnect, true, true, false},
        {"neos", "masternodecurrent", &masternodecurrent, true, true, false},
        {"neos", "masternodedebug", &masternodedebug, true, true, false},
        {"neos", "startmasternode", &startmasternode, true, true, false},
        {"neos", "createmasternodekey", &createmasternodekey, true, true, false},
        {"neos", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"neos", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"neos", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"neos", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"neos", "getmasternodescores", &getmasternodescores, true, true, false},
        {"neos", "mnbudget", &mnbudget, true, true, false},
        {"neos", "preparebudget", &preparebudget, true, true, false},
        {"neos", "submitbudget", &submitbudget, true, true, false},
        {"neos", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"neos", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"neos", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"neos", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"neos", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"neos", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"neos", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"neos", "checkbudgets", &checkbudgets, true, true, false},
        {"neos", "mnsync", &mnsync, true, true, false},
        {"neos", "spork", &spork, true, true, false},
        {"neos", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"neos", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use neosd, or the -server option to neos-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> neos-cli " + methodname + " " + args + "\n";
}
